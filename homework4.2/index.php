  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work_experience[0]["title"] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience[0]["date"] ?></h6>
          <p><?php echo $work_experience[0]["description"] ?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work_experience[1]["title"] ?>/ something.com</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience[1]["date"] ?></h6>
          <p><?php echo $work_experience[1]["description"] ?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work_experience[2]["title"] ?>/ designsomething.com</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience[2]["date"] ?><span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?php echo $work_experience[2]["description"] ?></p><br>
        </div>
      </div>
